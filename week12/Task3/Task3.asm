...
M1	STR R0,R7,#0
	...
	STR R0,R7,#1	;when digtit1<0 reset digtit1=xF
	;
	;digtit2 countdown
	LDR R1,R7,#2
	ADD R1,R1,#-1
	...
	STR R0,R7,#2 	;when digtit2<0 reset digtit2=xF
	;
	;digtit3 countdown
	LDR R1,R7,#3
	ADD R1,R1,#-1
	...
	STR R0,R7,#3	;when digtit3<0 reset digtit3=xF
	BR M1	
;
;register location
digtit	.BLKW 4
